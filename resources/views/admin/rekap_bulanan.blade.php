...
<div class="admin-wrapper">
    ...
    {{-- Sidebar --}}
    @include('admin.partials.sidebar', ['activePage' => 'rekap'])
    ...
    <div class="admin-main">
        ...
        <header class="admin-mobile-topbar">
            ...
            <span class="mobile-topbar-title"><i class="fa-solid fa-table-list"></i> Rekap Presensi</span>
        </header>
        ...
        <div class="admin-content-area">
            ...
            <div class="page-header" style="display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:1rem;">
                ...
                <div style="display:flex; gap:0.5rem; flex-wrap:wrap;">
                    <a href="{{ route('admin.rekap.preview', request()->all()) }}" target="_blank" class="btn btn-secondary btn-sm" style="display:inline-flex; align-items:center; gap:0.4rem;">
                        <i class="fa-solid fa-print"></i> Pratinjau Cetak
                    </a>
                    <a href="{{ route('admin.rekap.export.pdf', request()->all()) }}" class="btn btn-secondary btn-sm" style="display:inline-flex; align-items:center; gap:0.4rem; color:var(--accent-rose); border-color:rgba(244,63,94,0.3);">
                        <i class="fa-solid fa-file-pdf"></i> Unduh PDF
                    </a>
                    <a href="{{ route('admin.rekap.export.excel', request()->all()) }}" class="btn btn-primary btn-sm" style="display:inline-flex; align-items:center; gap:0.4rem; background:#059669; border-color:#059669;">
            ...
            {{-- Filter Bar --}}
            <form method="GET" action="{{ route('admin.rekap.index') }}" id="rekapFilterForm"
                ...
                <div style="display:flex; gap:0.5rem; align-items:flex-end;">
                    ...
                    <a href="{{ route('admin.rekap.index') }}" class="btn btn-secondary btn-sm" style="height:38px; padding:0 1rem; display:inline-flex; align-items:center; justify-content:center;">

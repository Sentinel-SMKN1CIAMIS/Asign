...
<div class="admin-wrapper">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.25rem; flex-wrap: wrap; gap: 1rem;">
        ...
        <div style="position: relative; display: inline-block;" id="exportDropdownWrapper">
            ...
            <div id="exportDropdownMenu" style="display:none; position:absolute; right:0; top:calc(100% + 6px); background:var(--card-bg); border:1.5px solid var(--card-border); border-radius:var(--radius-md); box-shadow:var(--card-shadow); min-width:220px; z-index:100; overflow:hidden;">
                ...
                @endphp
                <a href="{{ route('admin.sessions.preview', array_merge(['id' => $session->id], $exportParams)) }}"
                   target="_blank"
                   ...
                   onmouseover="this.style.background='rgba(99,102,241,0.07)'" onmouseout="this.style.background='transparent'">
                    ...
                    <div>
                        <div style="font-weight:600;">Pratinjau / Cetak PDF</div>
                        <div style="font-size:0.75rem; color:var(--text-muted);">Buka pratinjau &bull; Ctrl+P untuk simpan PDF</div>
                    </div>
                </a>
    ...
    {{-- Filter Bar --}}
    <form method="GET" action="{{ route('admin.sessions.detail', $session->id) }}" id="filterForm"
        ...
        <div style="flex:1; min-width:160px;">
            <label for="filter_search" style="font-size:0.78rem; font-weight:700; color:var(--text-muted); text-transform:uppercase; margin-bottom:0.3rem; display:flex; align-items:center; gap:0.25rem;"><i class="fa-solid fa-magnifying-glass"></i> Cari Nama</label>
            <input type="text" name="search" id="filter_search" aria-label="Cari Nama Peserta" value="{{ request('search') }}"
        ...
        <div style="min-width:150px;">
            <label for="filter_jabatan" style="font-size:0.78rem; font-weight:700; color:var(--text-muted); text-transform:uppercase; margin-bottom:0.3rem; display:flex; align-items:center; gap:0.25rem;"><i class="fa-solid fa-briefcase"></i> Jabatan</label>
            <select name="jabatan" id="filter_jabatan" aria-label="Pilih Jabatan" onchange="this.form.submit()"
                    style="width:100%; padding:0.5rem 0.75rem; border:1.5px solid var(--input-border); border-radius:var(--radius-sm); background:var(--input-bg); color:var(--text-main); font-size:0.88rem;">
        ...
        <div style="min-width:140px;">
            <label for="filter_date_from" style="font-size:0.78rem; font-weight:700; color:var(--text-muted); text-transform:uppercase; margin-bottom:0.3rem; display:flex; align-items:center; gap:0.25rem;"><i class="fa-solid fa-calendar-day"></i> Dari Tanggal</label>
            <input type="date" name="date_from" id="filter_date_from" aria-label="Dari Tanggal" value="{{ request('date_from') }}" onchange="this.form.submit()"
                   style="width:100%; padding:0.5rem 0.75rem; border:1.5px solid var(--input-border); border-radius:var(--radius-sm); background:var(--input-bg); color:var(--text-main); font-size:0.88rem;">
        </div>

        <div style="min-width:140px;">
            <label for="filter_date_to" style="font-size:0.78rem; font-weight:700; color:var(--text-muted); text-transform:uppercase; margin-bottom:0.3rem; display:flex; align-items:center; gap:0.25rem;"><i class="fa-solid fa-calendar-day"></i> Sampai Tanggal</label>
            <input type="date" name="date_to" id="filter_date_to" aria-label="Sampai Tanggal" value="{{ request('date_to') }}" onchange="this.form.submit()"
                   style="width:100%; padding:0.5rem 0.75rem; border:1.5px solid var(--input-border); border-radius:var(--radius-sm); background:var(--input-bg); color:var(--text-main); font-size:0.88rem;">
        </div>
        ...
        <div style="display:flex; gap:0.5rem; align-items:flex-end;">
            ...
            <a href="{{ route('admin.sessions.detail', $session->id) }}" class="btn btn-secondary btn-sm" style="height:38px; padding:0 1rem; display:inline-flex; align-items:center; justify-content:center;">
